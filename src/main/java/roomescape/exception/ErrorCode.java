...
public enum ErrorCode {
    ...
    USER_NAME_FORMAT_ERROR(HttpStatus.BAD_REQUEST, "이름은 영어 또는 한글만 가능합니다."),
    USER_NAME_LENGTH_ERROR(HttpStatus.BAD_REQUEST, "이름은 2~10자만 가능합니다."),
    USER_PASSWORD_LENGTH_ERROR(HttpStatus.BAD_REQUEST, "비밀번호는 4자 이상만 가능합니다."),
    USER_PASSWORD_EMPTY_ERROR(HttpStatus.BAD_REQUEST, "비밀번호가 없습니다."),
    ...
    THEME_NAME_LENGTH_ERROR(HttpStatus.BAD_REQUEST, "테마이름은 1~20자만 가능합니다."),
    THEME_DESCRIPTION_LENGTH_ERROR(HttpStatus.BAD_REQUEST, "설명은 10글자 이상 입력해주세요."),
    THEME_THUMBNAIL_LENGTH_ERROR(HttpStatus.BAD_REQUEST, "썸네일은 1자 이상 가능합니다."),
