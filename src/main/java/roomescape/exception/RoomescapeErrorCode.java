...
public enum RoomescapeErrorCode implements ErrorCodeWithHttpStatusCode {
    ...
    REQUEST_TIMEOUT(HttpStatus.BAD_REQUEST, "요청 시간이 만료되었습니다."),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "예상하지 못한 오류가 발생했습니다.");

    private final HttpStatusCode httpStatusCode;
    private final String message;

    RoomescapeErrorCode(HttpStatusCode httpStatusCode, String message) {
