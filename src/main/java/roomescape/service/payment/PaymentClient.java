...
public class PaymentClient {
    ...
    private static final String SECRET_KEY = "test_gsk_docs_OaPz8L5KdmQXkzRz3y47BMw6O";
    ...
    private PaymentConfirmErrorCode getPaymentConfirmErrorCode(final ClientHttpResponse response) throws IOException {
        PaymentConfirmFailResponse confirmFailResponse = objectMapper.readValue(response.getBody(), PaymentConfirmFailResponse.class);
