...
public record WaitingToReservationRequest(
    ...
    public WaitingApproveRequest toWaitingApproveRequest(long reservationId, Member member) {
        return new WaitingApproveRequest(reservationId, member, accountNumber, accountHolder, bankName, amount);
    }
}
