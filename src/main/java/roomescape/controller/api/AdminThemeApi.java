...
public interface AdminThemeApi {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "중복된 테마 이름인 경우", content = @Content),
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "정상 응답"),
            @ApiResponse(responseCode = "400", description = "예약이 존재하는 테마인 경우", content = @Content),
            @ApiResponse(responseCode = "404", description = "id에 해당하는 테마가 없는 경우", content = @Content),
    })
