...
public class Payment extends BaseEntity {
    ...
    public Payment(String paymentKey, long amount) {
        this(null, paymentKey, amount, null);
    }

    public Payment(Long id, String paymentKey, long amount, Reservation reservation) {
        this.id = id;
    ...
    public Payment(String paymentKey, long amount, Reservation reservation) {
        this(null, paymentKey, amount, reservation);
    }

    public Payment(long id, Payment payment) {
        this(id, payment.paymentKey, payment.amount, payment.reservation);
    }
