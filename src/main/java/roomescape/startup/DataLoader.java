...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // reservation
        Reservation reservation_horror_jojo = reservationRepository.save(new Reservation(jojo, TODAY, horror, time10_00, SUCCESS));
        Reservation waiting_horror_solar = reservationRepository.save(new Reservation(solar, TODAY, horror, time10_00, WAIT));
        Reservation reservation_sf_brown = reservationRepository.save(new Reservation(brown, TODAY, sf, time12_00, SUCCESS));
        Reservation waiting_sf_jojo = reservationRepository.save(new Reservation(jojo, TODAY, sf, time12_00, WAIT));
        Reservation reservation_zombie_googoo = reservationRepository.save(new Reservation(googoo, TOMORROW, zombie, time14_30, SUCCESS));
        Reservation reservation_zombie_jojo = reservationRepository.save(new Reservation(jojo, TOMORROW, zombie, time14_30, WAIT));
        Reservation reservation_monkey_jojo = reservationRepository.save(new Reservation(jojo, TODAY.plusDays(2), monkey, time11_00, SUCCESS));
        Reservation reservation_nagayaSanda_jojo = reservationRepository.save(new Reservation(jojo, TODAY.plusDays(5), nagayaSanda, time10_00, SUCCESS));
        Reservation reservation_virus_jojo = reservationRepository.save(new Reservation(jojo, TODAY.plusDays(7), virus, time12_30, SUCCESS));
        Reservation reservation_virus_neo = reservationRepository.save(new Reservation(neo, TODAY.plusDays(3), virus, time11_30, SUCCESS));
        Reservation reservation_horrorThemePark_bre = reservationRepository.save(new Reservation(bre, TODAY.plusDays(2), horrorThemePark, time14_30, SUCCESS));
        Reservation reservation_horror_pobi = reservationRepository.save(new Reservation(pobi, TODAY.plusDays(2), horror, time14_30, SUCCESS));
        Reservation reservation_titanic_tomi = reservationRepository.save(new Reservation(tomi, TODAY.plusDays(3), titanic, time10_30, SUCCESS));
        Reservation reservation_artGallery_risa = reservationRepository.save(new Reservation(risa, TODAY.plusDays(4), artGallery, time14_00, SUCCESS));
        Reservation waiting_horror_jojo = reservationRepository.save(new Reservation(jojo, TODAY.plusDays(2), horror, time14_30, WAIT));

        // payment
        List<Payment> payments = List.of(
                new Payment("5EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "MC4wODU4ODQwMzg4NDk0", 10000L, reservation_horror_jojo),
                new Payment("4EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "kC4wODU4ODQwMzg4NDk0", 11000L, reservation_sf_brown),
                new Payment("3EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "1C4wODU4ODQwMzg4NDk0", 10500L, reservation_zombie_googoo),
                new Payment("2EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "8C4wODU4ODQwMzg4NDk0", 10000L, reservation_monkey_jojo),
                new Payment("1EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "dC4wODU4ODQwMzg4NDk0", 10000L, reservation_nagayaSanda_jojo),
                new Payment("6EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "zC4wODU4ODQwMzg4NDk0", 12000L, reservation_virus_jojo),
                new Payment("7EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "wC4wODU4ODQwMzg4NDk0", 12000L, reservation_virus_neo),
                new Payment("8EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "oC4wODU4ODQwMzg4NDk0", 11000L, reservation_horrorThemePark_bre),
                new Payment("9EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "aC4wODU4ODQwMzg4NDk0", 10000L, reservation_horror_pobi),
                new Payment("0EnNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "2w4wODU4ODQwMzg4NDk0", 10500L, reservation_titanic_tomi),
                new Payment("22nNZRJGvaBX7zk2yd8ydw26XvwXkLrx9POLqKQjmAw4b0e1", "Ad4wODU4ODQwMzg4NDk0", 10500L, reservation_artGallery_risa)
        );
