            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    ...
                                    description = "대기를 생성하려는 방탈출의 예약이 존재하지 않는 경우, 대기가 아닌 예약을 요청해주세요.",
                                    value = "detail: 2024-10-11의 time: 1, theme: 1의 예약이 존재하지 않습니다."))),
                    @ApiResponse(responseCode = "400", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "동일한 회원의 동일한 방탈출 대기 중복",
                                    description = "이미 동일한 방탈출의 대기가 등록되어 있는 경우.",
                                    value = "detail: memberId: 1인 회원이 reservationId: 1인 예약에 대해 이미 대기를 신청했습니다."))),
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "존재하지 않는 회원",
                                    description = "로그인된 회원이 서버에 존재하지 않을 경우에 발생합니다. 토큰이 조작되었거나 회원이 삭제되었을 수 있습니다. 해당 문제가 아니라면 서버에 문의해주세요.",
                                    value = "detail: 식별자 1에 해당하는 회원 존재하지 않습니다.")))})
