...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("""
            SELECT new roomescape.dto.service.ReservationPaymentWithRankResponse(r1, p, COUNT(r2))
            FROM Reservation r1
            ...
            GROUP BY r1
            """)
    List<ReservationPaymentWithRankResponse> findAllWithRankByMemberId(long memberId);
