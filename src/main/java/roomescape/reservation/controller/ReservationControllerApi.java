...
public abstract class ReservationControllerApi {
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "이미 존재하는 예약",
                                    description = "해당 테마에 대한 예약이 존재하는 경우",
                                    value = "detail: 이미 2020-11-11의 행복한 라면가게 테마에는 11:00시의 예약이 존재하여 예약을 생성할 수 없습니다."))),
                    @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json",
                            examples = {
                                    @ExampleObject(
                                            name = "존재하지 않는 시간",
                                            description = "생성하려는 예약의 시간이 서버에 존재하지 않는 경우",
                                            value = "detail: 식별자 1에 해당하는 시간이 존재하지 않습니다."),
                                    @ExampleObject(
                                            name = "존재하지 않는 테마",
                                            description = "생성하려는 예약의 테마가 서버에 존재하지 않는 경우",
                                            value = "detail: 식별자 1에 해당하는 테마가 존재하지 않습니다."),
                                    @ExampleObject(
                                            name = "존재하지 않는 회원",
                                            description = "생성하려는 예약의 회원이 서버에 존재하지 않는 경우",
                                            value = "detail: 식별자 1에 해당하는 회원이 존재하지 않습니다.")}))},
            parameters = @Parameter(name = "createReservationRequest", description = "생성하려는 예약의 정보를 담은 객체", required = true))
    abstract ResponseEntity<CreateReservationResponse> createReservation(
            AuthInfo authInfo, CreateMyReservationRequest createReservationRequest);
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "존재하지 않는 예약",
                                    description = "서버에 존재하지 않는 예약을 조회하려는 경우.",
                                    value = "detail: 식별자 1에 해당하는 예약 존재하지 않습니다.")))},
    ...
    abstract ResponseEntity<List<FindReservationResponse>> searchBy(Long themeId,
                                                                    Long memberId,
                                                                    LocalDate dateFrom,
                                                                    LocalDate dateTo);
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "사용 중인 테마",
                                    description = "해당 테마에 대한 예약이 존재하는 경우",
                                    value = "detail: 식별자 1인 테마를 사용 중인 예약이 존재합니다. 삭제가 불가능합니다."))),
                    @ApiResponse(responseCode = "403", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "삭제 권한 없음",
                                    description = "해당 예약에 대한 회원의 권한이 존재하지 않는 경우, 즉 회원이 생성한 예약이 아닌 경우 발생합니다.",
                                    value = "detail: 식별자 1인 예약에 대해 회원 식별자 1의 권한이 존재하지 않아, 삭제가 불가능합니다."))),
                    @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "존재하지 않는 예약",
                                    description = "삭제하려는 예약이 서버에 존재하지 않는 경우",
                                    value = "detail: 식별자 1에 해당하는 예약이 존재하지 않습니다.")))},
