...
public interface ReservationControllerDocs {
    ...
    ResponseEntity<List<ReservationResponse>> getReservations(ReservationConditionRequest request);
    ...
    ResponseEntity<ReservationResponse> createReservation(ReservationRequest request, LoginMember loginMember);
    ...
    ResponseEntity<Void> deleteReservationById(Long id);
    ...
    ResponseEntity<List<MyReservationAndWaitingResponse>> getMyReservations(LoginMember loginMember);
} 