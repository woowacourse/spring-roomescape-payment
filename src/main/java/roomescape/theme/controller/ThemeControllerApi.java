            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "403", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "테마 생성 권한 없음",
                                    description = "로그인된 유저가 테마를 생성할 수 없는 권한인 경우",
                                    value = "detail: 회원의 권한이 없어, 테마를 생성할 수 없습니다.")))},
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json",
                            examples = @ExampleObject(
                                    name = "존재하지 않는 테마",
                                    description = "거절하려는 테마의 식별자 대한 정보가 서버에 존재하지 않는 경우",
                                    value = "detail: 식별자 1에 해당하는 테마가 존재하지 않습니다. 삭제가 불가능합니다.")))},
