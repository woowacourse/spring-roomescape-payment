...
public class DataLoader implements ApplicationRunner {
    ...
    private void runDataLoader() {
        Theme theme1 = themeRepository.save(new Theme("파라오의 비밀(이집트덕후모험/중급)", """
                ...
                """,
                "https://naverbooking-phinf.pstatic.net/20201109_121/1604908062178KzsNV_JPEG/%C6%C4%B6%F3%BF%C0%C0%C7%BA%F1%B9%D0.jpeg",10000L)
                );
        ...
        Theme theme2 = themeRepository.save(
                new Theme("좀비어택(재미있는공포/초중급)", """
                        ...
                        """,
                        "https://naverbooking-phinf.pstatic.net/20201109_262/1604908247778Wgjrb_JPEG/%C1%BB%BA%F1%BE%EE%C5%C3.jpeg",20000L)
        );
        ...
        Theme theme3 = themeRepository.save(
                new Theme("추적자(스릴러/초급)", """
                        ...
                        """,
                        "https://naverbooking-phinf.pstatic.net/20201109_271/1604906887897VLkai_JPEG/%C3%DF%C0%FB%C0%DA.jpeg",25000L)
        );
        ...
        Theme theme4 = themeRepository.save(
                new Theme("비밀갤러리생일파티(안무서워/중급)", """
                        ...
                        """,
                        "https://naverbooking-phinf.pstatic.net/20201104_210/160445696075352J6M_JPEG/%BA%F1%B9%D0%B0%B6%B7%AF%B8%AE.jpeg",30000L)
        );
