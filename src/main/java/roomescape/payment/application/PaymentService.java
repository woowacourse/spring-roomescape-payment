...
public class PaymentService {
    ...
    public PaymentService(final PaymentRepository paymentRepository, final TossPaymentGatewayClient tossPaymentGatewayClient) {
    ...
    public Payment addPayment(
        ...
        Payment payment = new Payment(new PaymentInfo(response.paymentKey(), response.orderId(), response.easyPay().amount()),
