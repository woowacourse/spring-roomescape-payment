...
VALUES (1, 'payment_key1', 1000, 'order_id1'),
       ...
       (5, 'payment_key5', 1000, 'order_id5'),
       (6, 'payment_key6', 1000, 'order_id6'),
       (7, 'payment_key7', 1000, 'order_id7'),
       (8, 'payment_key8', 1000, 'order_id8'),
       (9, 'payment_key9', 1000, 'order_id9'),
       (10, 'payment_key10', 1000, 'order_id10');
