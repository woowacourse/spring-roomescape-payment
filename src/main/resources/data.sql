...
VALUES 
    ( 'payment_key_test_1', 'ROOM_ESCAPE_test_1', '방탈출 예약 결제 1건', 1000),
    ( 'payment_key_test_2', 'ROOM_ESCAPE_test_2', '방탈출 예약 결제 1건', 1000),
    ( 'payment_key_test_3', 'ROOM_ESCAPE_test_3', '방탈출 예약 결제 1건', 1100),
    ( 'payment_key_test_4', 'ROOM_ESCAPE_test_4', '방탈출 예약 결제 1건', 1200),
    ( 'payment_key_test_5', 'ROOM_ESCAPE_test_5', '방탈출 예약 결제 1건', 1300),
    ( 'payment_key_test_6', 'ROOM_ESCAPE_test_6', '방탈출 예약 결제 1건', 1400),
    ( 'payment_key_test_7', 'ROOM_ESCAPE_test_7', '방탈출 예약 결제 1건', 1500),
    ( 'payment_key_test_8', 'ROOM_ESCAPE_test_8', '방탈출 예약 결제 1건', 1600),
    ( 'payment_key_test_9', 'ROOM_ESCAPE_test_9', '방탈출 예약 결제 1건', 1700),
    ( 'payment_key_test_10', 'ROOM_ESCAPE_test_10', '방탈출 예약 결제 1건', 1800),
    ( 'payment_key_test_11', 'ROOM_ESCAPE_test_11', '방탈출 예약 결제 1건', 1900),
    ( 'payment_key_test_12', 'ROOM_ESCAPE_test_12', '방탈출 예약 결제 1건', 2000);
