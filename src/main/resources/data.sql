...
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('1', 1, 1, DATEADD('DAY', -1, CURRENT_DATE), 1, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('2', 1, 1, DATEADD('DAY', -2, CURRENT_DATE), 1, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('3', 1, 1, DATEADD('DAY', -3, CURRENT_DATE), 1, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('4', 2, 1, DATEADD('DAY', -1, CURRENT_DATE), 1, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('5', 2, 2, DATEADD('DAY', -2, CURRENT_DATE), 2, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('6', 3, 2, DATEADD('DAY', -3, CURRENT_DATE), 2, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('7', 4, 2, DATEADD('DAY', -1, CURRENT_DATE), 2, 'DONE');
insert into reservation (id, theme_id, member_id, date, time_slot_id, status)
values ('8', 5, 2, DATEADD('DAY', -2, CURRENT_DATE), 2, 'DONE');

INSERT INTO payment (id, payment_key, amount, reservation_id, status)
VALUES ('1', 'paymentKey1', 200000, 1, 'DONE'),
       ('2', 'paymentKey2', 200000, 2, 'DONE'),
       ('3', 'paymentKey3', 200000, 3, 'DONE'),
       ('4', 'paymentKey4', 200000, 4, 'DONE'),
       ('5', 'paymentKey5', 200000, 5, 'DONE'),
       ('6', 'paymentKey6', 200000, 6, 'DONE'),
       ('7', 'paymentKey7', 200000, 7, 'DONE'),
       ('8', 'paymentKey8', 200000, 8, 'DONE');