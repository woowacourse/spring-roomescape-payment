...
function render(data) {
    ...
    data.forEach(item => {
        ...
        */
        ...
        row.insertCell(2).textContent = item.schedule.theme.name;      // 테마 name
        row.insertCell(3).textContent = item.schedule.date;            // date
        row.insertCell(4).textContent = item.schedule.time.startAt;    // 예약 시간 startAt
