...
:path_create_theme: theme/create-theme
:path_create_theme_admin: theme/create-theme/admin

:path_delete_theme: theme/delete-theme
...
=== 요청
include::{snippets}/{path_create_theme}/http-request.adoc[]

==== 요청 헤더
로그인 시 응답받은 쿠키 값을 설정합니다.
include::{snippets}/{path_create_theme}/request-cookies.adoc[]

==== 요청 바디
include::{snippets}/{path_create_theme}/request-body.adoc[]
include::{snippets}/{path_create_theme}/request-fields.adoc[]

=== 응답
include::{snippets}/{path_create_theme}/http-response.adoc[]

==== 응답 바디
include::{snippets}/{path_create_theme}/response-body.adoc[]
include::{snippets}/{path_create_theme}/response-fields.adoc[]

=== 에러 메시지
이미 존재하는 테마이름을 추가하려 하면 에러 메시지를 응답한다.
include::{snippets}/{path_create_theme}/exception/already-exist/response-body.adoc[]
include::{snippets}/{path_create_theme}/exception/already-exist/response-fields.adoc[]
...
=== 요청
include::{snippets}/{path_delete_theme}/http-request.adoc[]

==== 요청 헤더
로그인 시 응답받은 쿠키 값을 설정합니다.
include::{snippets}/{path_delete_theme}/request-cookies.adoc[]


=== 응답
include::{snippets}/{path_delete_theme}/http-response.adoc[]

=== 에러 메시지
존재하지 않는 테마를 삭제하면 에러 메시지가 응답한다.
include::{snippets}/{path_delete_theme}/exception/not-exist/response-body.adoc[]
include::{snippets}/{path_delete_theme}/exception/not-exist/response-fields.adoc[]

이미 사용중인 테마를 삭제하면 에러 메시지가 응답한다.
include::{snippets}/{path_delete_theme}/exception/already-exist/response-body.adoc[]
include::{snippets}/{path_delete_theme}/exception/already-exist/response-fields.adoc[]
