...
public class AdminReservationApiTest {
    ...
    static void initParams() {
        SCHEDULE_BODY.put("date", "2026-12-01");
        SCHEDULE_BODY.put("reservationTimeId", "1");
        SCHEDULE_BODY.put("themeId", "1");

        RESERVATION_BODY.put("scheduleId", "1");
    ...
    class ReadAllByMemberAndThemeAndDateRange {
        ...
        void readAllByMemberAndThemeAndDateRange(final Long memberId, final Long themeId, final String from,
            ...
            jdbcTemplate.update("""
                    ...
                    """);
            jdbcTemplate.update("""
                        INSERT INTO schedule (date, reservation_time_id, theme_id) VALUES
                        ('2025-05-07', 1, 1),
                        ('2025-05-07', 1, 2),
                        ('2025-05-08', 1, 2);
                    """);
            jdbcTemplate.update("""
                        INSERT INTO reservation (member_id, schedule_id) VALUES
                        (1, 1),
                        (1, 2),
                        (1, 3);
                    """);
