...
class ReservationTest {
    ...
    void 지난_날짜에_대한_예약이라면_예외가_발생한다(final LocalDateTime currentDateTime, final LocalDateTime reservationDateTime) {
        // given
    ...
    void 예약일이_오늘인_경우_예약_시간까지_10분도_남지_않았다면_예외가_발생한다(final LocalDateTime currentDateTime, final LocalDateTime reservationDateTime) {
        // given
        final Reservation reservation = new Reservation(
                new Member(1L, "test1", new Email("email1@gmail.com"), "password", MemberRole.NORMAL),
                reservationDateTime.toLocalDate(),
