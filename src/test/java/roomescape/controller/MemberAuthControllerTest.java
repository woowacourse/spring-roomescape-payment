...
class MemberAuthControllerTest extends ControllerTest {
    ...
    void login_IllegalEmail(String illegalEmail) {
        TokenRequest request = new TokenRequest(illegalEmail,
                VALID_USER_PASSWORD.getPassword());
    ...
    @Test
    void signUp() {
        MemberSignUpRequest request = new MemberSignUpRequest("스티치",
                "test@gmail.com", "1234");
    ...
    void signUp_IllegalName(String illegalName) {
        MemberSignUpRequest request = new MemberSignUpRequest(illegalName,
                "test@gmail.com", "1234");
