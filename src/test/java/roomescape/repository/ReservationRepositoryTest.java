...
class ReservationRepositoryTest {
    ...
    void setUp() {
        ...
        reservation = reservationRepository.save(new Reservation(member, DATE_MAY_EIGHTH, reservationTime, theme, "결제완", 1000));
    ...
    void save() {
        // given
        final Reservation reservation = new Reservation(member, DATE_MAY_NINTH, reservationTime, theme, "결제완", 1000);
