...
public class PaymentFixture {
    public static final Payment DEFAULT_PAYMENT_WITHOUT_ID = new Payment("paymentKey", 1000);
    public static final Payment DEFAULT_PAYMENT = new Payment(1L, "paymentKey", 100, DEFAULT_RESERVATION);
    ...
    public static final ApproveApiResponse DEFAULT_APPROVE_RESPONSE = new ApproveApiResponse(
            DEFAULT_APPROVE_REQUEST.paymentKey(), DEFAULT_APPROVE_REQUEST.amount()
    );
}
