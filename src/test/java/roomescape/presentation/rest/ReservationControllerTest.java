...
class ReservationControllerTest {
    ...
    void cannotReserveWhenBadRequest() throws Exception {
        var paymentFailedException = new PaymentFailedException(new PaymentFailure(PaymentFailCode.CONDITION_NOT_SATISFIED, "결제 실패"));
    ...
    void cannotReserveWhenInternalServerError() throws Exception {
        var paymentFailedException = new PaymentFailedException(new PaymentFailure(PaymentFailCode.INVALID_AUTH_CREDENTIALS, "결제 실패"));
        Mockito.doThrow(paymentFailedException)
                .when(paymentService).pay(anyString(), anyString(), anyLong());
