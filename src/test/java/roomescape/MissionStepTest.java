...
public class MissionStepTest {
    ...
    void third() {
        ...
        params.put("paymentKey", "temp_key");
        params.put("orderId", "temp_id");
    ...
    void fifth() {
        ...
        final Integer count = jdbcTemplate.queryForObject("SELECT count(1) from reservation",
            Integer.class);
    ...
    void sixth() {
        ...
        final Integer countAfterDelete = jdbcTemplate.queryForObject(
