...
import roomescape.infrastructure.member.JpaMemberRepository;
import roomescape.infrastructure.theme.JpaThemeRepository;
import roomescape.infrastructure.time.JpaReservationTimeRepository;
...
class JpaReservationRepositoryTest {
    ...
    void 일주일_이내의_인기있는_예약_테마_정보_조회() {
        ...
        jpaThemeRepository.save(theme1);
        jpaThemeRepository.save(theme2);
        final Member member = new Member("name", "email", "password", Role.USER);
        jpaMemberRepository.save(member);
