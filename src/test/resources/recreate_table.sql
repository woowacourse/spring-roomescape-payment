...
(
    ...
    status         varchar(255) default 'CONFIRMATION' check (status in ('CONFIRMATION', 'WAITING', 'PENDING')),
    primary key (id)
);
...
INSERT INTO reservation (date, time_id, theme_id) -- pk: 1
VALUES ('2099-12-31', 1, 1);
INSERT INTO reservation (date, time_id, theme_id) -- 2
VALUES ('2099-12-31', 1, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 3
VALUES ('2024-12-01', 1, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 4
VALUES ('2024-12-02', 1, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 5
VALUES ('2024-12-02', 2, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 6
VALUES ('2024-12-03', 1, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 7
VALUES ('2024-12-04', 1, 2);

INSERT INTO reservation (date, time_id, theme_id) -- 8
VALUES (FORMATDATETIME(DATEADD('DAY', -3, NOW()), 'yyyy-MM-dd'), 2, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 9
VALUES (FORMATDATETIME(DATEADD('DAY', -4, NOW()), 'yyyy-MM-dd'), 1, 2);
INSERT INTO reservation (date, time_id, theme_id) -- 10
VALUES (FORMATDATETIME(DATEADD('DAY', -5, NOW()), 'yyyy-MM-dd'), 1, 1);

INSERT INTO reservation (date, time_id, theme_id) -- 11
VALUES ('2024-12-31', 4, 4);
INSERT INTO reservation (date, time_id, theme_id) -- 12
VALUES ('2025-12-31', 4, 4);
INSERT INTO reservation (date, time_id, theme_id) -- 13
VALUES ('2025-12-29', 4, 4);
...
INSERT INTO member_reservation(member_id, reservation_id, status) -- 15
VALUES (3, 13, 'PENDING');
