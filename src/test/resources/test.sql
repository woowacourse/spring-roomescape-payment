...
INSERT INTO reservation (date, time_id, theme_id, member_id, status, payment_id)
VALUES (DATEADD('DAY', -4, CURRENT_DATE), 2, 2, 1, 'CONFIRMED', NULL);

INSERT INTO reservation (date, time_id, theme_id, member_id, status, payment_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 2, 2, 2, 'CONFIRMED', NULL);

INSERT INTO reservation (date, time_id, theme_id, member_id, status, payment_id)
VALUES (DATEADD('DAY', -3, CURRENT_DATE), 3, 1, 2, 'CONFIRMED', NULL);
