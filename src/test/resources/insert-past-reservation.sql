...
INSERT INTO reservation(visit_date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -7, CURRENT_DATE), 1, 2, 2);
INSERT INTO reservation(visit_date, time_id, member_id, theme_id) VALUES (DATEADD('DAY', -8, CURRENT_DATE), 1, 3, 3);
