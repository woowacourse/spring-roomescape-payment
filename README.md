...
- 로그아웃할 수 있다.
- 회원가입할 수 있다.
- 이미 예약이 존재할 경우 예약 대기를 추가할 수 있다.
- 결제를 통해 예약을 추가할 수 있다.
- 자신의 예약대기와 에약상태를 조회할 수 있다. 이 때, 결제가 완료된 예약은 결제 정보도 확인 가능하다.

### 관리자

- 모든 회원의 정보를 조회할 수 있다.
- 필터를 통해 모든 예약을 조회할 수 있다.
- 다른 회원의 예약을 추가할 수 있다.
- 예약을 삭제할 수 있다.
- 새로운 예약 시간을 추가할 수 있다.
- 예약 시간을 삭제할 수 있다.
...
- 모든 예약을 조회할 수 있다.
- 모든 에약 시간들을 조회할 수 있다.
- 예약 여부 정보를 포함한  예약 시간들을 조회할 수 있다.
- 모든 테마를 조회할 수 있다.
- 상위 10개의 인기 테마를 조회할 수 있다.
- 모든 에약 대기를 조회할 수 있다.
  ...
  "data": [
    {
      ...
      "time": "10:00",
      "reservedStatus": "예약"
      "paymentKey": "tgen_202506091258425H0c4", 
      "amount": 1000
    },
    {
      "reservationId": 2,
