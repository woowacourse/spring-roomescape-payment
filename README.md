...
- [x] 사용자 관련 기능
    ...
    - [x] 사용자가 날짜, 테마, 시간을 선택하고 결제하여야 예약할 수 있다.
...
- [x] 예약 시 결제단계 추가
    ...
    - [x] 결제 승인 API 호출에 실패하면 에러를 핸들링 한다.
        - [x] 결제 실패 사유를 알 수 있다.
...
내 예약 페이지에서 예약 정보 외에 결제 정보도 함께 볼 수 있도록 기능 추가 ( paymentKey, 결제 금액 )

### 3단계

배포 URL : 43.202.53.143:8080

### 4단계

모든 API를 확인 할 수 있는 API 문서 작성 자동화
모니터링 및 에러 트래킹을 위해 로그 레벨을 구분하여 로그를 기록 기능 추가
